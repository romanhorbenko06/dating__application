 ...
 *
 * Формат визначається за СИГНАТУРОЮ файлу (перші байти), а не за розширенням
 * імені чи заголовком Content-Type: і те, і інше надсилає клієнт, і те, і інше
 * можна підробити. Інакше на диск ліг би файл із розширенням .jpg, усередині
 * якого зовсім не картинка, а браузер потім спробував би це відрендерити.
 */
public enum ImageFormat {
    ...
    /** byte у Java знаковий, тож для порівняння з сигнатурами приводимо до 0..255. */
